...
public class KeyFramesTimeline extends Pane {
    ...
    private final ObjectProperty<GameObject> currentObject;
    ...
    public KeyFramesTimeline(KeyFrameTag tag, ObjectProperty<GameObject> currentObject) {
            ...
            if (hoveringAddButton && currentObject.get() != null) {
                ...
                if (opt.isPresent()) {
                    ...
                    currentObject.get().addKeyFrame(
                            GameObject.getDefaultValueForTag(tag),
    ...
    public ObjectProperty<GameObject> currentObjectProperty() {
        return currentObject;
    }
