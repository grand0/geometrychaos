...
import ru.kpfu.itis.gr201.ponomarev.geometrychaos.common.anim.randomizer.DoubleValueRandomizer;
...
import ru.kpfu.itis.gr201.ponomarev.geometrychaos.editorapp.util.converter.DoubleStringConverter;
import ru.kpfu.itis.gr201.ponomarev.geometrychaos.editorapp.util.converter.InterpolatorsStringConverter;
...
public class KeyFrameEditor extends Pane {
    ...
    private final ObjectProperty<GameObject> kfParent;
    ...
    public KeyFrameEditor(ObjectProperty<ObjectKeyFrame> selectedKeyFrame, ObjectProperty<GameObject> selectedObject) {
    ...
    private void redraw() {
        ...
        Label kfGlobalTime = makeLabel(String.valueOf(keyFrame.get().getTime() + kfParent.get().getStartTime()));
        ...
        gridPane.addRow(0, makeLabel("Time"), timeSpinner, kfGlobalTime);
    ...
    public GameObject getKfParent() {
        return kfParent.get();
    }

    public ObjectProperty<GameObject> kfParentProperty() {
        return kfParent;
    }

    public void setKfParent(GameObject kfParent) {
